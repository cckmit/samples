...
import static over35.samples.amqp.config.MqConstant.TOPIC_QUEUE_PREFIX;
...
public class TopicConsumer {
    ...
    @SneakyThrows
    @RabbitListener(queues = TOPIC_QUEUE_PREFIX +1)
    @RabbitHandler
    ...
    @SneakyThrows
    @RabbitListener(queues = TOPIC_QUEUE_PREFIX +2)
    @RabbitHandler
    ...
    @SneakyThrows
    @RabbitListener(queues = TOPIC_QUEUE_PREFIX +3)
    @RabbitHandler
